...
select transaction_date as 'Date of Transaction', sum(total_sale) as 'Total Sales' from Retail_Sales where transaction_date = "2023-11-22" group by transaction_date; -- total sale on "2023-11-22".
...
-- Q.2 write an sql query retrieve all transactions for the "clothing" category, and the quantity sold is more than 3 in the month of nov-2022 -->
...
-- Q.3 write an sql query to calculate total sales for each category -->
...
-- Q.4 write an sql query to find average age of customers who purchased items from the 'Beauty' category -->
...
-- Q.5 write an sql query to find all the transactions where total sale is greater than 1000 -->
...
select Shift, count(*) as 'Total Orders' from shift_wise_sales group by Shift;
