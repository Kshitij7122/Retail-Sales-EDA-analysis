...
2. **Set Up the Database**: Run the SQL scripts provided in the `MySQL_Query_Script.sql` file to create and populate the database.
3. **Run the Queries**: Use the SQL queries provided in the `MySQL_Query_Script.sql` file to perform your analysis.
